...
class Dept(models.Model):
    ...
    college = models.ForeignKey(College, models.DO_NOTHING, db_column='College_id')  # Field name made lowercase.
...
class Principal(models.Model):
    ...
    college = models.OneToOneField(College, models.DO_NOTHING, db_column='College_id')  # Field name made lowercase.
